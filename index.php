...
?>
    ...
    <!-- Standalone CSS Calling For Page -->
        <?php if (!empty($this->options->CDNUrl)): ?>
            <link class="pjax-load " rel="stylesheet" type="text/css" media="all" href="<?php $this->options->CDNUrl(); ?>/MaterialCDN/css/index-2c60ba9df6.css" />
        <?php else: ?>
            <link class="pjax-load" rel="stylesheet" type="text/css" media="all" href="<?php $this->options->themeUrl('css/index-2c60ba9df6.css'); ?>" />
        <?php endif; ?>
    <!-- Standalone CSS END -->

    <link rel="prefetch" href="<?php $this->options->themeUrl('css/post-179b103ee1.css') ?>" as="style">
